...
void Display_Voltage_Net(void)
{
    LCD_Clear(WHITE);
    POINT_COLOR = GREEN;
    for(int t  = 10;t<LCD_Height;t=t+20)//画竖着的网格
	{LCD_DrawLine(0, t, LCD_Height, t);}
	for(int t  = 10;t<LCD_Height;t=t+20)//画横着的网格
    ...
    LCD_ShowChar(230, 210, 'T', 16);
    LCD_ShowChar(0, 0, 'V', 16);
}
